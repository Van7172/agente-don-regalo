...
HUMAN_HANDOFF_TOOL = {
    ...
    "function": {
        ...
        "description": (
            ...
            "NO la uses solo porque diga corporativo, Fiestas Patrias, colegio, "
            "empresa, mayorista, catálogo o elija '2 y 3': pregunta cantidad/"
            "presupuesto o muestra productos. "
            "SÍ úsala si además piden asesor, hay frustración, pago/comprobante, "
            "descuento, cancelación o algo que no puedas verificar. "
